...
class LckhPengawasController extends Controller
{
    /**
    ...
    {
        return view('pengawas.LCKHCreate', [
            'users' => User::all(),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($lckh) {
            return redirect()->route('lckhPengawas.index')->with('success', 'Data Dokumen LCKH berhasil ditambahkan!');
        } else {
    ...
    public function update(Request $request, Lckh_reports $lckh)
    {
        ...
        if ($lckh->save()) {
            return redirect()->route('lckhPengawas.index')->with('success', 'Dokumen LCKH berhasil diupdate!');
        } else {
